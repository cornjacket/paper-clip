...
## Details
Out-of-process workers, capability-gated host services, job scheduling, tool exposure, and UI contributions. Plugins can add knowledge bases, custom tracing, queues, and more.
