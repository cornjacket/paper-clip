...
tags:
  - "clippings"
---
[![Paperclip is the app people use to manage AI agents for work.](https://github.com/paperclipai/paperclip/raw/master/doc/assets/banner.jpg)](https://github.com/paperclipai/paperclip/blob/master/doc/assets/banner.jpg)

[**Quickstart**](#quickstart) · [**Docs**](https://paperclip.ing/docs) · [**GitHub**](https://github.com/paperclipai/paperclip) · [**Discord**](https://discord.gg/m4HZY7xNG3) · [**Twitter**](https://x.com/papercliping) · [**Website**](https://paperclip.ing/)
...
| ### 🛡️ Governance  Approve hires, override strategy, pause or terminate any agent — at any time. | ### 📊 Org Chart  Hierarchies, roles, reporting lines. Your agents have a boss, a title, and a job description. | ### 📱 Mobile Ready  Monitor and manage your autonomous businesses from anywhere. |
